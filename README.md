...
로그인 없이 이름·구매정보와 영수증 파일을 받아 중화중학교 담당자의 비공개 Google Drive에 저장하는 소형 웹앱입니다.

화면은 밝은 흰 배경, 단일 초록 액션 컬러, 그림자 없는 회색 카드로 구성한 중화중학교 전용 AI 접수 브랜드를 사용합니다. 외부 폰트나 이미지 요청은 하지 않습니다.
